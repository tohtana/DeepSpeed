...
def record_scheduler_decision(*,
    ...
    _append(
        "scheduler", _scheduler_decisions, {
            ...
            "max_gathered_bytes": int(max_gathered_bytes) if max_gathered_bytes is not None else None,
            "max_live_gathered_bytes": int(max_live_gathered_bytes),
            "budget_rejections": int(budget_rejections),
            "over_budget_fallbacks": int(over_budget_fallbacks),
            "minimum_rejected_candidate_peak_bytes": (
                int(minimum_rejected_candidate_peak_bytes)
