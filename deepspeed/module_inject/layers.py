...
def collect_autotp_universal_checkpoint_info(model: nn.Module) -> Dict[str, Any]:
    ...
    # Use the same canonical, de-duplicated parameter names that checkpoint
    # creation records. Shared parameters may be reachable through multiple
    # module aliases, but strict conversion rejects patterns for aliases that
    # are absent from the optimizer checkpoint.
